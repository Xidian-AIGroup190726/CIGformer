...
def parse_args():
    ...
    parser.add_argument('-s', '--src_file',  default= r'F:\3dataset\ps_data3\QB\Dataset\train_low_res', help='source file name')
    parser.add_argument('-n', '--num', type=int, default=10, help='total image id to convert')
    parser.add_argument('-d', '--dst_dir', default= r'F:\3dataset\ps_data3\QB\Dataset\examples', help='saved directory')
...
if __name__ == '__main__':
    ...
    for delta in range(tot):
        ...
        for file_name in ['_ms.tif', '_ms_label.tif', '_pan.tif']:
            image_id = delta
